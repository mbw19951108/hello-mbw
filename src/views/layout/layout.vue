<template>
  <!-- github 外链图标 -->
  <a href="https://github.com/mbw19951108/ppdouble" class="github-corner" aria-label="View source on GitHub"><svg
      width="60" height="60" viewBox="0 0 250 250"
      style="fill:#001529; color:#fff; position: absolute; top: 64; border: 0; right: 0;" aria-hidden="true">
